...
locals {
  autoscaling_enabled = var.enabled ? true : false
}

resource "aws_autoscaling_policy" "scale_up" {
  count                  = var.autoscaling_enabled ? 1 : 0
  name                   = "${var.project_name}${var.delimiter}${terraform.workspace}${var.delimiter}scale${var.delimiter}up"
...
resource "aws_autoscaling_policy" "scale_down" {
  count                  = var.autoscaling_enabled ? 1 : 0
  name                   = "${var.project_name}${var.delimiter}${terraform.workspace}${var.delimiter}scale${var.delimiter}down"
...
resource "aws_cloudwatch_metric_alarm" "cpu_high" {
  count               = var.autoscaling_enabled ? 1 : 0
  alarm_name          = "${var.project_name}${var.delimiter}${terraform.workspace}${var.delimiter}cpu${var.delimiter}utilization${var.delimiter}high"
...
resource "aws_cloudwatch_metric_alarm" "cpu_low" {
  count               = var.autoscaling_enabled ? 1 : 0
  alarm_name          = "${var.project_name}${var.delimiter}${terraform.workspace}${var.delimiter}cpu${var.delimiter}utilization${var.delimiter}low"
